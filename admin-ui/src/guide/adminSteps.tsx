...
export const USAGE_STEPS: GuideStep[] = [
  ...
  {
    target: "usage-findings",
    title: "What stands out",
    body: "The page's own first pass at the numbers: stuck cases, screens people struggle on, a cycle time that got slower. Each line says what happened and where to look -- start here.",
    placement: "bottom",
  },
  {
    target: "usage-tiles",
  ...
  },
  {
    target: "usage-export",
    title: "Export",
    body: "Copy the summary as text for Jira or Slack, download every raw event as CSV, or take everything as one JSON file. Every table on the other tabs has its own CSV button too.",
    placement: "top",
  },
  {
  ...
  {
    target: "usage-tab-friction",
    title: "Friction",
    body: "Where they struggle: every screen ranked by one friction score built from bounces, back-and-forth, dead clicks and rage clicks -- plus the cases stuck in the pipeline right now.",
    placement: "bottom",
  },
  {
