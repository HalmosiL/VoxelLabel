...
def ingest_dicom_file(self, job_id: str, project_id: str, staging_key: str) -> dict:
    """Parse, de-identify, upload and register a single staged DICOM file."""
    try:
        return ingest_dicom(job_id=job_id, project_id=project_id, staging_key=staging_key)
